...
// make a map object
var myMap = L.map("map", {
    center: [36.7783, -119.4179],  // Coordinates for California (example)
    zoom: 5,
    ...
    function(earthquakeData){
        ...
        function radiusSize(mag){
            if (mag == 0)
                ...
                return mag * 5; // makes sure that circle is pronounced in the map
        }
        ...
        // add the GEOJson Data to the earthquale layer group
